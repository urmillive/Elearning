    ...
    return (
        <div className="max-w-sm rounded overflow-hidden shadow-lg">
            ...
            <div className="text-center my-3">
                <button type="button" class="display-block text-white bg-slate-900 hover:bg-slate-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-md px-20 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
